...
import { Alert, Button, Col, Divider, Menu, Row } from "antd";
...
function App(props) {
  ...
  const [stackAmmount, setStackAmmount] = useState(0.5);
          ...
          <Route exact path="/">
            ...
            >
              <input
                ...
                type="number"
                placeholder="Enter Amount you want to Stack"
                value={stackAmmount}
                onChange={e => setStackAmmount(e.target.value)}
              ></input>
              <Button
                style={{
                  width: "30%",
                ...
                onClick={() => {
                  tx(writeContracts.Staker.stake({ value: ethers.utils.parseEther(stackAmmount) }));
                }}
              >
                🥩 Stake {stackAmmount} ether!
              </Button>
            </div>
